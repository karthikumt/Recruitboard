...
class Edit_Sports extends CI_Controller {
	...
	{		
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		if($getUser['UserType']=='1')
		{
			$StuID = get_sport_detail($getUser['UserID']);
			$SportID=$StuID['Stu_SportID'];
			
		}
		if($getUser['UserType']==2)
		{
			$StuID = get_juco_detail($getUser['UserID']);
			$SportID=$StuID['Juco_SportID'];
		
		}
			
		if($SportID=='28')
		{
			redirect(base_url().'edit_sports/baseball');	
		}
		else if($SportID=='29')
		{
			redirect(base_url().'edit_sports/basketball');	
		}
		else if($SportID=='30')
		{
			redirect(base_url().'edit_sports/bowling');	
		}
		else if($SportID=='31')
		{
			redirect(base_url().'edit_sports/cheerleading');	
		}
		else if($SportID=='32')
		{
			redirect(base_url().'edit_sports/crew');	
		}
		else if($SportID=='33')
		{
			redirect(base_url().'edit_sports/cross_country');	
		}
		else if($SportID=='34')
		{
			redirect(base_url().'edit_sports/dance_team');	
		}
		else if($SportID=='35')
		{
			redirect(base_url().'edit_sports/fencing');	
		}
		else if($SportID=='36')
		{
			redirect(base_url().'edit_sports/field_hockey');	
		}
		else if($SportID=='37')
		{
			redirect(base_url().'edit_sports/football');	
		}
		
		else if($SportID=='38')
		{
			redirect(base_url().'edit_sports/golf');	
		}
		else if($SportID=='39')
		{
			redirect(base_url().'edit_sports/mens_gymnastics');	
		}
		else if($SportID=='40')
		{
			redirect(base_url().'edit_sports/ice_hockey');	
		}
		else if($SportID=='41')
		{
			redirect(base_url().'edit_sports/indor_track');	
		}
		else if($SportID=='42')
		{
			redirect(base_url().'edit_sports/lacrosse');	
		}
		else if($SportID=='43')
		{
			redirect(base_url().'edit_sports/rifle');	
		}
		else if($SportID=='44')
		{
			redirect(base_url().'edit_sports/rugby');	
		}
		else if($SportID=='45')
		{
			redirect(base_url().'edit_sports/skiing');	
		}
		else if($SportID=='46')
		{
			redirect(base_url().'edit_sports/soccer');	
		}
		else if($SportID=='47')
		{
			redirect(base_url().'edit_sports/softball');	
		}
		else if($SportID=='48')
		{
			redirect(base_url().'edit_sports/swimming');	
		}
		else if($SportID=='49')
		{
			redirect(base_url().'edit_sports/tennis');	
		}
		else if($SportID=='50')
		{
			redirect(base_url().'edit_sports/track');	
		}
		else if($SportID=='51')
		{
			redirect(base_url().'edit_sports/volleyball');	
		}
		else if($SportID=='52')
		{
			redirect(base_url().'edit_sports/water_polo');	
		}
		else if($SportID=='53')
		{
			redirect(base_url().'edit_sports/wrestling');	
		}
		else if($SportID=='54')
		{
			redirect(base_url().'edit_sports/womens_gymnastics');	
		}
		else if($SportID=='55')
		{
			redirect(base_url().'edit_sports/rowing');	
		}
		else{
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('baseball_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/baseball',$data, true);
	...
	public function insert_baseball()
		{
			...
			if($Stu_info['Bas_Player']!='' && $Stu_info['Bas_HighSchool']!='' && $Stu_info['Bas_City']!='' && $Stu_info['Bas_State']!=''){
					...
					$this->general_model->update_data('baseball_sport',$Stu_info,array('UserID'=>$UserID));
					...
					$this->session->set_flashdata('successmessage','Sport Profile Updated Successfully.');
					redirect(base_url().'edit_sports/baseball');
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('basketball_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/basketball',$data, true);
		$this->load->view('template', $data);	
	}
	...
	public function insert_basketball()
	{
		...
		if($Stu_info['Bask_PlayerName']!='' && $Stu_info['Bask_SchoolName']!='' && $Stu_info['Bask_City']!='' && $Stu_info['Bask_State']!=''){
				...
				$last_id=$this->general_model->update_data('basketball_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('bowling_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/bowling',$data, true);
		$this->load->view('template', $data);	
	}
	...
	public function insert_bowling()
	{
		...
		if($Stu_info['Bowl_PlayerName']!='' && $Stu_info['Bowl_Highschool']!='' && $Stu_info['Bowl_City']!='' && $Stu_info['Bowl_State']!=''){
				...
				$last_id=$this->general_model->update_data('bowling_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('cheerleading_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/cheerleading',$data, true);
		$this->load->view('template', $data);	
	}
	...
	public function insert_cheerleading()
	{
		...
		if($Stu_info['Cheer_PlayerName']!='' && $Stu_info['Cheer_SchoolName']!='' && $Stu_info['Cheer_City']!='' && $Stu_info['Cheer_State']!=''){
				...
				$last_id=$this->general_model->update_data('cheerleading_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function cross_country()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('cross_country_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/cross_country',$data, true);
		$this->load->view('template', $data);	
	}
	public function insert_cross_country()
	{
		...
		if($Stu_info['Cross_PlayerName']!='' && $Stu_info['Cross_SchoolName']!='' && $Stu_info['Cross_City']!='' && $Stu_info['Cross_State']!=''){
				...
				$last_id=$this->general_model->update_data('cross_country_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function dance_team()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('danceteam_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/dance_team',$data, true);
		$this->load->view('template', $data);	
	...
	public function insert_dance_team()
	{
		...
		if($Stu_info['Dance_PlayerName']!='' && $Stu_info['Dance_SchoolName']!='' && $Stu_info['Dance_City']!='' && $Stu_info['Dance_State']!=''){
				...
				$last_id=$this->general_model->update_data('danceteam_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('fencing_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/fencing',$data, true);
		$this->load->view('template', $data);				
	}
	...
	public function insert_fencing()
	{
		...
		if($Stu_info['Fence_PlayerName']!='' && $Stu_info['Fence_SchoolName']!='' && $Stu_info['Fence_City']!='' && $Stu_info['Fence_State']!=''){
				...
				$last_id=$this->general_model->update_data('fencing_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function field_hockey()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('field_hockey_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/field_hockey',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_field_hockey()
	{
		...
		if($Stu_info['Field_PlayerName']!='' && $Stu_info['Field_SchoolName']!='' && $Stu_info['Field_City']!='' && $Stu_info['Field_State']!=''){
				...
				$last_id=$this->general_model->update_data('field_hockey_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('football_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/football',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_football()
	{
		...
		if($Stu_info['FootBall_PlayerName']!='' && $Stu_info['FootBall_SchoolName']!='' && $Stu_info['FootBall_City']!='' && $Stu_info['FootBall_State']!=''){
				...
				$last_id=$this->general_model->update_data('football_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function golf()
	{
			...
			$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
			$data['Sport_info']=$this->general_model->get_single_data_by_column('golf_sport','UserID',$getUser['UserID']);
			$data['MainContent'] = $this->load->view('edit_sports/golf',$data, true);
			$this->load->view('template', $data);
	...
	public function insert_golf()
	{
		...
		if($Stu_info['Golf_PlayerName']!='' && $Stu_info['Golf_SchoolName']!='' && $Stu_info['Golf_City']!='' && $Stu_info['Golf_State']!=''){
				...
				$last_id=$this->general_model->update_data('golf_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function mens_gymnastics()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('men_gym_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/mens_gymnastics',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_mens_gymnastics()
	{
		...
		if($Stu_info['Gym_PlayerName']!='' && $Stu_info['Gym_SchoolName']!='' && $Stu_info['Gym_City']!='' && $Stu_info['Gym_State']!=''){
				...
				$last_id=$this->general_model->update_data('men_gym_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function ice_hockey()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('ice_hockey_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/ice_hockey',$data, true);
		$this->load->view('template', $data);
   ...
   public function insert_ice_hockey()
	{
		...
		if($Stu_info['Ice_PlayerName']!='' && $Stu_info['Ice_SchoolName']!='' && $Stu_info['Ice_City']!='' && $Stu_info['Ice_State']!=''){
				...
				$last_id=$this->general_model->update_data('ice_hockey_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function indor_track()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('indoor_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/indoor_track',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_indoor_track()
	{
		...
		if($Stu_info['Indoor_PlayerName']!='' && $Stu_info['Indoor_SchoolName']!='' && $Stu_info['Indoor_City']!='' && $Stu_info['Indoor_State']!=''){
				...
				$last_id=$this->general_model->update_data('indoor_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function lacrosse()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('lacross_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/lacrosse',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_lacrosse()
	{
		...
		if($Stu_info['Lac_PlayerName']!='' && $Stu_info['Lac_SchoolName']!='' && $Stu_info['Lac_City']!='' && $Stu_info['Lac_State']!=''){
				...
				$last_id=$this->general_model->update_data('lacross_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function rifle()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('rifle_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/rifle',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_rifle()
	{
		...
		if($Stu_info['Rifel_PlayerName']!='' && $Stu_info['Rifel_SchoolName']!='' && $Stu_info['Rifel_City']!='' && $Stu_info['Rifel_State']!=''){
				...
				$last_id=$this->general_model->update_data('rifle_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function rugby()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('rugby_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/rugby',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_rugby()
	{
		...
		if($Stu_info['Rugby_PlayerName']!='' && $Stu_info['Rugby_SchoolName']!='' && $Stu_info['Rugby_City']!='' && $Stu_info['Rugby_State']!=''){
				...
				$last_id=$this->general_model->update_data('rugby_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('skiing_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/skiing',$data, true);
		$this->load->view('template', $data);	
	}
	...
	public function insert_skiing()
	{
		...
		if($Stu_info['Skiing_PlayerName']!='' && $Stu_info['Skiing_SchoolName']!='' && $Stu_info['Skiing_City']!='' && $Stu_info['Skiing_State']!=''){
				...
				$last_id=$this->general_model->update_data('skiing_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('soccer_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/soccer',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_soccer()
	{
		...
		if($Stu_info['Soccer_PlayerName']!='' && $Stu_info['Soccer_SchoolName']!='' && $Stu_info['Soccer_City']!='' && $Stu_info['Soccer_State']!=''){
				...
				$last_id=$this->general_model->update_data('soccer_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function softball()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('softball_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/softball',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_softball()
	{
		...
		if($Stu_info['Soft_PlayerName']!='' && $Stu_info['Soft_SchoolName']!='' && $Stu_info['Soft_City']!='' && $Stu_info['Soft_State']!=''){
				...
				$last_id=$this->general_model->update_data('softball_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function swimming()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('swimming_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/swimming',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_swimming()
	{
		...
		if($Stu_info['Swim_PlayerName']!='' && $Stu_info['Swim_SchoolName']!='' && $Stu_info['Swim_City']!='' && $Stu_info['Swim_State']!=''){
				...
				$last_id=$this->general_model->update_data('swimming_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('tennis_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/tennis',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_tennis()
	{
		...
		if($Stu_info['Tenis_PlayerName']!='' && $Stu_info['Tenis_SchoolName']!='' && $Stu_info['Tenis_City']!='' && $Stu_info['Tenis_State']!=''){
				...
				$last_id=$this->general_model->update_data('tennis_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function track()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('track_and_field_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/track',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_track()
	{
		...
		if($Stu_info['Track_PlayerName']!='' && $Stu_info['Track_SchoolName']!='' && $Stu_info['Track_City']!='' && $Stu_info['Track_State']!=''){
				...
				$last_id=$this->general_model->update_data('track_and_field_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('volleyball_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/volleyball',$data, true);
		$this->load->view('template', $data);
	}
	...
	public function insert_volleyball()
	{
		...
		if($Stu_info['Volly_PlayerName']!='' && $Stu_info['Volly_SchoolName']!='' && $Stu_info['Volly_City']!='' && $Stu_info['Volly_State']!=''){
				...
				$last_id=$this->general_model->update_data('volleyball_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('water_polo_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/water_polo',$data, true);
		$this->load->view('template', $data);
	}
	...
	public function insert_water_polo()
	{
		...
		if($Stu_info['Water_PlayerName']!='' && $Stu_info['Water_SchoolName']!='' && $Stu_info['Water_City']!='' && $Stu_info['Water_State']!=''){
				...
				$last_id=$this->general_model->update_data('water_polo_sport',$Stu_info,array('UserID'=>$UserID));
	...
	public function wrestling()
	{
		...
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('wrestling_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/wrestling',$data, true);
		$this->load->view('template', $data);	
	...
	public function insert_wrestling()
	{
		...
		if($Stu_info['Wrest_PlayerName']!='' && $Stu_info['Wrest_SchoolName']!='' && $Stu_info['Wrest_City']!='' && $Stu_info['Wrest_State']!=''){
				...
				$last_id=$this->general_model->update_data('wrestling_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('women_gym_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/womens_gymnastics',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_womens_gymnastics()
	{
		...
		if($Stu_info['Women_PlayerName']!='' && $Stu_info['Women_SchoolName']!='' && $Stu_info['Women_City']!='' && $Stu_info['Women_State']!=''){
				...
				$last_id=$this->general_model->update_data('women_gym_sport',$Stu_info,array('UserID'=>$UserID));
	...
	{
		$getUser=get_user_detail($this->session->userdata('MyRecuritID'));
		$data['Sport_info']=$this->general_model->get_single_data_by_column('rowing_sport','UserID',$getUser['UserID']);
		$data['MainContent'] = $this->load->view('edit_sports/rowing',$data, true);
		$this->load->view('template', $data);
	...
	public function insert_rowing()
	{
		...
		if($Stu_info['Row_PlayerName']!='' && $Stu_info['Row_SchoolName']!='' && $Stu_info['Row_City']!='' && $Stu_info['Row_State']!=''){
				...
				$last_id=$this->general_model->update_data('rowing_sport',$Stu_info,array('UserID'=>$UserID));
