   ...
   <div class="HomeLoader" id="ProcessLoaderID"></div>
        <div class="inner-content">
        	<div class="wrapper">
            	...
            	<div class="reg-title">
                    <h3>One last thing, your film is your resume. Please add a video that best represents you and your school.</h3>
                ...
                <?php }?>
                  <form name="teach_step3" method="post" action="<?php echo base_url('highschool_teacher/insert_step3'); ?>" onsubmit="return check_teach_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                <div class="reg-frm">
