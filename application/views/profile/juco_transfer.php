	<div class="dashboard-profile">
		<div class="wrapper">
        	<div class="my_Account">
                ...
                <?php }?>
                  <form name="stu_step1" method="post" action="<?php echo base_url('profile/update_profile_juco'); ?>" onsubmit="return check_stu_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                ...
                <div class="da-update">
                    ...
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                            ...
                            <select name="Juco_GenderID" id="Juco_GenderID">
                             <option value="0">
                            	...
                            	<option value="<?php echo $gender_info[$i]['GenderID']; ?>" <?php if($gender_info[$i]['GenderID']==$Profile['Juco_GenderID']){ ?> selected="selected" <?php } ?> >
                        ...
                        <div class="inner-frm fr">
                            ...
                            <input type="text" placeholder="School Name" name="Juco_SchoolName" id="Juco_SchoolName" value="<?php echo $Profile['Juco_SchoolName']; ?>" >
                        </div>
                    </div>
                    	...
                    	<div class="inner-frm fl">
                            ...
                            <select name="Juco_CountryID" id="Juco_CountryID">
                             ...
                             <?php  $country_info=get_table_details('country','CountryID'); ?>
                            	...
                            	<option value="<?php echo $country_info[$i]['CountryID']; ?>" <?php if($country_info[$i]['CountryID']==$Profile['Juco_CountryID']){ ?> selected="selected" <?php } ?> >
                        ...
                        <div class="inner-frm fr">
                           ...
                           <select name="Juco_State" id="Juco_State">
                             ...
                             <?php  $country_info=get_table_details('state_list','StateID'); ?>
                                 <?php for($i=0;$i<count($country_info);$i++){ ?>
                            	<option value="<?php echo $country_info[$i]['StateID']; ?>" <?php if($country_info[$i]['StateID']==$Profile['Juco_State']){ ?> selected="selected" <?php } ?> >
                    ...
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                        	<span>City</span>
                             <input type="text" placeholder="City" name="Juco_City" id="Juco_City" value="<?php echo $Profile['Juco_City']; ?>">
                         </div>
                        <div class="inner-frm fr">
                        	<span>Zip Code</span>
                            <input type="text" placeholder="Zip/Postal Code" name="Juco_ZipCode" id="Juco_ZipCode" value="<?php echo $Profile['Juco_ZipCode']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                            ...
                            <?php  $class_info=get_table_details('stu_athlete_class','ClassID'); ?>
                            	...
                            	<option value="<?php echo $class_info[$i]['ClassID']; ?>"  <?php if($class_info[$i]['ClassID']==$Profile['Juco_ClassID']){ ?> selected="selected" <?php } ?> >
                        ...
                        <div class="inner-frm fr">
                            ...
                            <div class="inner-frm fl">
                                <select name="Juco_HeightID" id="Juco_HeightID">
                                  ...
                                  <?php $height_info=get_table_details('stu_athlete_height','HeightID'); ?>
                                    ...
                                    <option value="<?php echo $height_info[$i]['HeightID']; ?>" <?php if($height_info[$i]['HeightID']==$Profile['Juco_HeightID']){ ?> selected="selected" <?php } ?>>
                            ...
                            <select name="Juco_InchesID" id="Juco_InchesID">
                              ...
                              <?php $height_info=get_table_details('stu_athlete_inches','InchesID'); ?>
                                 <?php for($i=0;$i<count($height_info);$i++){ ?>
                            	<option value="<?php echo $height_info[$i]['InchesID']; ?>"  <?php if($height_info[$i]['InchesID']==$Profile['Juco_InchesID']){ ?> selected="selected" <?php } ?>>
                        ...
                        <div class="frm clearfix">
                            	...
                            	<option value="<?php echo $width_info[$i]['WeightID']; ?>"  <?php if($width_info[$i]['WeightID']==$Profile['Juco_WeightID']){ ?> selected="selected" <?php } ?>>
                    ...
                    <div class="reg-frm">
                    	<div class="frm clearfix">
                    		<div class="cols-5">
                                ...
                                <input type="text" placeholder="Player Name" name="Juco_Act_Player" id="Juco_Act_Player" value="<?php echo $Profile['Juco_Act_Player']; ?>">               
                            </div>
                            <div class="cols-5">
                            <span>School Name</span>
                            	<input type="text" placeholder="High School Name" name="Juco_Act_HighSchool" id="Juco_Act_HighSchool" value="<?php echo $Profile['Juco_Act_HighSchool']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>City</span>
                            	<input type="text" placeholder="City" name="Juco_Act_City" id="Juco_Act_City" value="<?php echo $Profile['Juco_Act_City']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>State</span>
                            	<input type="text" placeholder="State" name="Juco_Act_State" id="Juco_Act_State" value="<?php echo $Profile['Juco_Act_State']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>Class Of</span>
                            	<input type="text" placeholder="Class of 20" name="Juco_Act_Class" value="<?php echo $Profile['Juco_Act_Class']; ?>">
                            </div>
                        </div>
                    ...
                    <div class="student-card clearfix">
                    	<div class="cols-small">
                        	<div class="reg-frm pitching-stats">
                            	...
                            	<option value="<?php echo $Education_details[$i]['EducationID']; ?>" <?php if($Education_details[$i]['EducationID']==$Profile['Juco_Act_ActScore']){ ?> selected="selected"  <?php } ?>>
                            	...
                            	<option value="<?php echo $Education_details_sat[$i]['Education_sat_ID']; ?>" <?php if($Education_details_sat[$i]['Education_sat_ID']==$Profile['Juco_Act_SatScore']){ ?> selected="selected"  <?php } ?>>
                            	...
                            	<option value="<?php echo $Education_gpa_details[$i]['Education_gpa_ID']; ?>" <?php if($Education_gpa_details[$i]['Education_gpa_ID']==$Profile['Juco_Act_Gpa']){ ?> selected="selected"  <?php } ?>>
                               ...
                               <span>Core GPA</span>
                            	...
                            	<option value="<?php echo $Education_Core_Gpa_details[$i]['Education_Core_Gpa_ID']; ?>" <?php if($Education_Core_Gpa_details[$i]['Education_Core_Gpa_ID']==$Profile['Juco_Act_CoreGpa']){ ?> selected="selected"  <?php } ?>>
                            ...
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                        ...
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Arts" value="1"  <?php if($Profile['Juco_Act_Arts']==1){?> checked="checked" <?php } ?>>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Religion
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Religion" value="1" <?php if($Profile['Juco_Act_Religion']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Clubs/organizations
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Clubs" value="1" <?php if($Profile['Juco_Act_Clubs']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Community Service
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Community" value="1" <?php if($Profile['Juco_Act_Community']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Student Goverment
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Goverment" value="1" <?php if($Profile['Juco_Act_Goverment']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Media / Newspaper
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Media" value="1" <?php if($Profile['Juco_Act_Media']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	MIlitary R.O.T.C
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Military" value="1" <?php if($Profile['Juco_Act_Military']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Music
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Music" value="1" <?php if($Profile['Juco_Act_Music']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    ...
                                    <input type="text" placeholder="Other" name="Juco_Act_Other" value="<?php echo $Profile['Juco_Act_Other']; ?>" >
                                </div>
                            </div>
                        </div>
						<div class="cols-big">
                        	<div class="reg-frm pitching-stats">
                            	<div class="image-upload">
                                    <span class="uploadimg" id="imagePreview1">
                                     ...
                                     <?php if($Profile['Juco_Act_ImageName']!='') { ?>
                                        <img src="<?php echo base_url('register_images/juco_transfer/small/'.$Profile['Juco_Act_ImageName'].''); ?>" alt="" id="image1"> <?php }else{ ?>
                                ...
                                <option value="<?php echo $Country_detail[$i]['Stu_TofelID']; ?>" <?php if($Country_detail[$i]['Stu_TofelID']==$Profile['Juco_Act_TofelScoreID']){ ?> selected="selected"<?php } ?>>
                                ...
                                <div class="frm">
                                      <select name="Juco_Act_ReadID">
                                        ...
                                        <?php $Country_detail = get_table_details('stu_academic_read','Stu_ReadID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_ReadID']; ?>" <?php if($Country_detail[$i]['Stu_ReadID']==$Profile['Juco_Act_ReadID']){ ?> selected="selected"<?php } ?>>
                                     ...
                                     <select name="Juco_Act_ListenID">
                                    	<option value="0">LIstening</option>
                                         <?php $Country_detail = get_table_details('stu_academic_listen','Stu_ListenID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_ListenID']; ?>" <?php if($Country_detail[$i]['Stu_ListenID']==$Profile['Juco_Act_ListenID']){ ?> selected="selected"<?php } ?>>
                                    ...
                                    <select name="Juco_Act_SpeakID">
                                    	<option value="0">Speaking</option>
                                         <?php $Country_detail = get_table_details('stu_academic_speak','Stu_SpeakID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_SpeakID']; ?>" <?php if($Country_detail[$i]['Stu_SpeakID']==$Profile['Juco_Act_SpeakID']){ ?> selected="selected"<?php } ?>>
                                ...
                                <?php } ?>
                                 ...
                                 <span>Writing</span>
                                <div class="frm">
                                      <select name="Juco_Act_WriteID">
                                    	<option value="0">Writing</option>
                                         <?php $Country_detail = get_table_details('stu_academic_write','Stu_WriteID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_WriteID']; ?>" <?php if($Country_detail[$i]['Stu_WriteID']==$Profile['Juco_Act_WriteID']){ ?> selected="selected"<?php } ?>>
                                     ...
                                     <select name="Juco_Act_YearSpeakID">
                                        ...
                                        <option value="0">Writing</option>
                                         <?php $Country_detail = get_table_details('stu_academic_yourspeak','Stu_YourSpeakID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_YourSpeakID']; ?>" <?php if($Country_detail[$i]['Stu_YourSpeakID']==$Profile['Juco_Act_YearSpeakID']){ ?> selected="selected"<?php } ?>>
                                    ...
                                    <select name="Juco_Act_YearReadID">
                                    	<option value="0">Years Reading English</option>
                                         <?php $Country_detail = get_table_details('stu_academic_yourwrite','Stu_YourWriteID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_YourWriteID']; ?>" <?php if($Country_detail[$i]['Stu_YourWriteID']==$Profile['Juco_Act_YearReadID']){ ?> selected="selected"<?php } ?>>
                                ...
                                <div class="frm">
                                      <select name="Juco_Act_YearWriteID">
                                        ...
                                        <?php $Country_detail = get_table_details('stu_academic_yourread','Stu_YourReadID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_YourReadID']; ?>" <?php if($Country_detail[$i]['Stu_YourReadID']==$Profile['Juco_Act_YearWriteID']){ ?> selected="selected"<?php } ?>>
                                ...
                                <div class="frm">
                                     <select name="Juco_Act_WesID">
                                        ...
                                        <?php $Country_detail = get_table_details('stu_academic_wes','Stu_WesID'); ?>
                                           <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Stu_WesID']; ?>" <?php if($Country_detail[$i]['Stu_WesID']==$Profile['Juco_Act_WesID']){ ?> selected="selected"<?php } ?>>
                        ...
                        <div class="cols-small">
                        	<div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <input type="text" placeholder="Name" name="Juco_Act_GuName" id="Juco_Act_GuName" value="<?php echo $Profile['Juco_Act_GuName']; ?>">
                                </div>
                                 <span>Counselor Email</span>
                                <div class="frm">
                                    <input type="text" placeholder="Email" name="Juco_Act_GuEmail" value="<?php echo $Profile['Juco_Act_GuEmail']; ?>">
                                </div>
                            </div>
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Honors Courses
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Honors" value="1" <?php if($Profile['Juco_Act_Honors']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                        ...
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Post" value="1" <?php if($Profile['Juco_Act_Post']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	AP Courses
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_ApCourses" value="1" <?php if($Profile['Juco_Act_ApCourses']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                 ...
                                 <span>Languages</span>
                                <div class="frm">
                                    <input type="text" placeholder="Languages" name="Juco_Act_Languages" <?php if($Profile['Juco_Act_Languages']==1){?> checked="checked" <?php } ?>>
                                </div>
                            </div>
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	NCAA
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Ncaa" value="1" <?php if($Profile['Juco_Act_Ncaa']==1){?> checked="checked" <?php } ?>>
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	NAIA
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Juco_Act_Naia" value="1" <?php if($Profile['Juco_Act_Naia']==1){?> checked="checked" <?php } ?>> 
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                            ...
                            <div class="reg-frm pitching-stats">
                            	...
                            	<option value="<?php echo $Eligibility_Intended_details[$i]['Eligibility_Intended_ID']; ?>" <?php if($Eligibility_Intended_details[$i]['Eligibility_Intended_ID']==$Profile['Juco_Act_IntendedID']){ ?> selected="selected"<?php } ?>>
                ...
                <div class="student-athlete biometric">
                    ...
                    <div class="reg-frm">
                    	<div class="frm clearfix">
                    		<div class="cols-5">
                            	<span>Player Name</span>
                                <input type="text" placeholder="Player Name" name="Juco_Ins_PlayerName" id="Juco_Ins_PlayerName" value="<?php echo $Profile['Juco_Ins_Player']; ?>" >
                            </div>
                            <div class="cols-5">
                            <span>School Name</span>
                            	<input type="text" placeholder="High School Name" name="Juco_Ins_HighSchool" id="Juco_Ins_HighSchool" value="<?php echo $Profile['Juco_Ins_HighSchool']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>City</span>
                            	<input type="text" placeholder="City" name="Juco_Ins_City" id="Juco_Ins_City" value="<?php echo $Profile['Juco_Ins_City']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>State</span>
                            	<input type="text" placeholder="State" name="Juco_Ins_State" id="Juco_Ins_State" value="<?php echo $Profile['Juco_Ins_State']; ?>">
                            </div>
                            <div class="cols-5">
                            <span>Class Of</span>
                            	<input type="text" placeholder="Class of 20" name="Juco_Ins_Class" id="Juco_Ins_Class" value="<?php echo $Profile['Juco_Ins_Class']; ?>">
                            </div>
                        </div>
                    ...
                    <div class="student-card clearfix">
                    	<div class="cols-small">
                                ...
                                <select name="Juco_Ins_Weight" id="Juco_Ins_Weight">
                                    <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_WeigthID']; ?>" <?php if($Gender['Stu_Bio_WeigthID']==$Profile['Juco_Ins_Weight']){ ?> selected="selected" <?php } ?> >
							...
							'Stu_Bio_HeightWithoutID'); ?>
                                <select name="Juco_Ins_HeightWithout" id="Juco_Ins_HeightWithout">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_HeightWithoutID']; ?>" <?php if($Gender['Stu_Bio_HeightWithoutID']==$Profile['Juco_Ins_HeightWithout']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Bio_HeightIncheWithoutID'); ?>
                                <select name="Juco_Ins_HeightIncheWithoutID" id="Juco_Ins_HeightIncheWithoutID">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_HeightIncheWithoutID']; ?>" <?php if($Gender['Stu_Bio_HeightIncheWithoutID']==$Profile['Juco_Ins_HeightIncheWithoutID']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Bio_HeigthID'); ?>
                                <select name="Juco_Ins_HeightWith" id="Juco_Ins_HeightWith">
                                     <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_HeigthID']; ?>"  <?php if($Gender['Stu_Bio_HeigthID']==$Profile['Juco_Ins_HeightWith']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Bio_HeightIncheID'); ?>
                                <select name="Juco_Ins_HeightIncheWithID" id="Juco_Ins_HeightIncheWithID">
                                     <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_HeightIncheID']; ?>" <?php if($Gender['Stu_Bio_HeightIncheID']==$Profile['Juco_Ins_HeightIncheWithID']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_WingSpanID'); ?>
                                    <select name="Juco_Ins_WingSpan" id="Juco_Ins_WingSpan">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_WingSpanID']; ?>" <?php if($Gender['Stu_Bio_WingSpanID']==$Profile['Juco_Ins_WingSpan']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_WingSpanIncheID'); ?>
                                    <select name="Juco_Ins_WingSpanIncheID" id="Juco_Ins_WingSpanIncheID">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_WingSpanIncheID']; ?>" <?php if($Gender['Stu_Bio_WingSpanIncheID']==$Profile['Juco_Ins_WingSpanIncheID']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_HandWidthID'); ?>
                                    <select name="Juco_Ins_HandWidth" id="Juco_Ins_HandWidth">
                                         <option value="0">
                                          ...
                                          <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_HandWidthID']; ?>" <?php if($Gender['Stu_Bio_HandWidthID']==$Profile['Juco_Ins_HandWidth']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_HandWidthIncheID'); ?>
                                    <select name="Juco_Ins_HandWidthIncheID" id="Juco_Ins_HandWidthIncheID">
                                         <option value="0">
                                          ...
                                          <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_HandWidthIncheID']; ?>" <?php if($Gender['Stu_Bio_HandWidthIncheID']==$Profile['Juco_Ins_HandWidthIncheID']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_HandLengthID'); ?>
                                    <select name="Juco_Ins_HandLength" id="Juco_Ins_HandLength">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_HandLengthID']; ?>"  <?php if($Gender['Stu_Bio_HandLengthID']==$Profile['Juco_Ins_HandLength']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Bio_HandLengthIncheID'); ?>
                                    <select name="Juco_Ins_HandLengthIncheID" id="Juco_Ins_HandLengthIncheID">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Bio_HandLengthIncheID']; ?>" <?php if($Gender['Stu_Bio_HandLengthIncheID']==$Profile['Juco_Ins_HandLengthIncheID']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Bio_DomaintHandID'); ?>
                                <select name="Juco_Ins_DominantHand" id="Juco_Ins_DominantHand">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_DomaintHandID']; ?>" <?php if($Gender['Stu_Bio_DomaintHandID']==$Profile['Juco_Ins_DominantHand']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Bio_DomaintLegID'); ?>
                                <select name="Juco_Ins_DominantLeg" id="Juco_Ins_DominantLeg">
                                    <option value="0">
                                        Dominant Leg
                                    </option>
                                     <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Bio_DomaintLegID']; ?>" <?php if($Gender['Stu_Bio_DomaintLegID']==$Profile['Juco_Ins_DominantLeg']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Body_MassID'); ?>
                                      	<?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Body_MassID']; ?>" <?php if($Gender['Stu_Body_MassID']==$Profile['Juco_Ins_BodyMass']){ ?> selected="selected" <?php } ?>>
						...
						<div class="cols-big">
                            	...
                            	<div class="image-upload">
                                    <span class="uploadimg" id="imagePreview2">
                                        <input type="file" name="Juco_Ins_ImageName" id="Juco_Ins_ImageName">
                                         <?php if($Profile['Juco_Ins_ImageName']!='') { ?>
                                        <img src="<?php echo base_url('register_images/juco_transfer/small/'.$Profile['Juco_Ins_ImageName'].''); ?>" alt="" id="image2"> <?php }else{ ?>
							...
							'Stu_Endu_PushID'); ?>
                                <select name="Juco_Ins_PushUp" id="Juco_Ins_PushUp">
                                    <option value="0">
                                       Push-ups in 1 minute
                                    </option>
                                    <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Endu_PushID']; ?>" <?php if($Gender['Stu_Endu_PushID']==$Profile['Juco_Ins_PushUp']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Endu_SitID'); ?>
                                <select name="Juco_Ins_SitUp" id="Juco_Ins_SitUp">
                                    ...
                                    <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Endu_SitID']; ?>" <?php if($Gender['Stu_Endu_SitID']==$Profile['Juco_Ins_SitUp']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Endu_PullID'); ?>
                                <select name="Juco_Ins_PullUp" id="Juco_Ins_PullUp">
                                    <option value="0">
                                     ...
                                     <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Endu_PullID']; ?>" <?php if($Gender['Stu_Endu_PullID']==$Profile['Juco_Ins_PullUp']){ ?> selected="selected" <?php } ?>>
                        ...
                        <div class="cols-small">
                                ...
                                <div class="frm">
                                      ...
                                      <?php $Gender_details=get_table_details('stu_strength_vertical',
                                        'Stu_Stre_VerticalID'); ?>
                                            <select name="Juco_Ins_Vertical" id="Juco_Ins_Vertical">
                                                ...
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Stre_VerticalID']; ?>" <?php if($Gender['Stu_Stre_VerticalID']==$Profile['Juco_Ins_Vertical']){ ?> selected="selected" <?php } ?>>
                                    ...
                                    <div class="sub-hight fr">
                                        ...
                                        'Stu_Stre_VerticalIncheID'); ?>
                                            <select name="Juco_Ins_VerticalIncheID" id="Stu_VerticalIncheID">
                                                <option value="0">
                                                   Select
                                                </option>
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Stre_VerticalIncheID']; ?>" <?php if($Gender['Stu_Stre_VerticalIncheID']==$Profile['Juco_Ins_VerticalIncheID']){ ?> selected="selected" <?php } ?>>
                                    ...
                                    'Stu_Stre_StandID'); ?>
                                        <select name="Juco_Ins_Standing" id="Juco_Ins_Standing">
                                            <option value="0">
                                             ...
                                             <?php foreach($Gender_details as $Gender){ ?>
                                                 <option value="<?php echo $Gender['Stu_Stre_StandID']; ?>" <?php if($Gender['Stu_Stre_StandID']==$Profile['Juco_Ins_Standing']){ ?> selected="selected" <?php } ?>>
                                    ...
                                    'Stu_Stre_StandIncheID'); ?>
                                        <select name="Juco_Ins_StandIncheingID" id="Juco_Ins_StandIncheingID">
                                            <option value="0">
                                             ...
                                             <?php foreach($Gender_details as $Gender){ ?>
                                                 <option value="<?php echo $Gender['Stu_Stre_StandIncheID']; ?>" <?php if($Gender['Stu_Stre_StandIncheID']==$Profile['Juco_Ins_StandIncheingID']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Stre_PowerID'); ?>
                                <select name="Juco_Ins_PowerClean" id="Juco_Ins_PowerClean">
                                    <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Stre_PowerID']; ?>" <?php if($Gender['Stu_Stre_PowerID']==$Profile['Juco_Ins_PowerClean']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Stre_BenchID'); ?>
                                <select name="Juco_Ins_Bench" id="Juco_Ins_Bench">
                                    <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Stre_BenchID']; ?>" <?php if($Gender['Stu_Stre_BenchID']==$Profile['Juco_Ins_Bench']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Stre_SquatID'); ?>
                                <select name="Juco_Ins_Squal" id="Juco_Ins_Squal">
                                    <option value="0">
                                      ...
                                      <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Stre_SquatID']; ?>" <?php if($Gender['Stu_Stre_SquatID']==$Profile['Juco_Ins_Squal']){ ?> selected="selected" <?php } ?>>
                                      ...
                                      <?php $Gender_details=get_table_details('stu_flexibility_sit',
                                        'Stu_Fle_SitID'); ?>
                                            <select name="Juco_Ins_Sit" id="Juco_Ins_Sit">
                                                ...
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Fle_SitID']; ?>" <?php if($Gender['Stu_Fle_SitID']==$Profile['Juco_Ins_Sit']){ ?> selected="selected" <?php } ?>>
                                    ...
                                    <div class="sub-hight fr">
                                        ...
                                        'Stu_Fle_ReachID'); ?>
                                            <select name="Juco_Ins_Reach" id="Juco_Ins_Reach">
                                                ...
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Fle_ReachID']; ?>"  <?php if($Gender['Stu_Fle_ReachID']==$Profile['Juco_Ins_Reach']){ ?> selected="selected" <?php } ?>>
                                    ...
                                    <div class="sub-hight fl">
                                        ...
                                        'Stu_Fle_BackID'); ?>
                                            <select name="Juco_Ins_Back" id="Juco_Ins_Back">
                                                ...
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Fle_BackID']; ?>"  <?php if($Gender['Stu_Fle_BackID']==$Profile['Juco_Ins_Back']){ ?> selected="selected" <?php } ?>>
                                      ...
                                      <?php $Gender_details=get_table_details('stu_flexibility_scartch',
                                        'Stu_Fle_ScartchID'); ?>
                                            <select name="Juco_Ins_BackScratch" id="Juco_Ins_BackScratch">
                                                ...
                                                <?php foreach($Gender_details as $Gender){ ?>
                                                     <option value="<?php echo $Gender['Stu_Fle_ScartchID']; ?>" <?php if($Gender['Stu_Fle_ScartchID']==$Profile['Juco_Ins_BackScratch']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Speed_YardID'); ?>
                                <select name="Juco_Ins_Yard" id="Juco_Ins_Yard">
                                    ...
                                    <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Speed_YardID']; ?>" <?php if($Gender['Stu_Speed_YardID']==$Profile['Juco_Ins_Yard']){ ?> selected="selected" <?php } ?>>
							...
							'Stu_Speed_YardIncheID'); ?>
                                <select name="Juco_Ins_YardIncheID" id="Juco_Ins_YardIncheID">
                                    ...
                                    <?php foreach($Gender_details as $Gender){ ?>
                                      	 <option value="<?php echo $Gender['Stu_Speed_YardIncheID']; ?>" <?php if($Gender['Stu_Speed_YardIncheID']==$Profile['Juco_Ins_YardIncheID']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Speed_YardDashID'); ?>
                                    <select name="Juco_Ins_YardDash" id="Juco_Ins_YardDash">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Speed_YardDashID']; ?>" <?php if($Gender['Stu_Speed_YardDashID']==$Profile['Juco_Ins_YardDash']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Speed_YardDashIncheID'); ?>
                                    <select name="Juco_Ins_YardDashIncheID" id="Juco_Ins_YardDashIncheID">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Speed_YardDashIncheID']; ?>" <?php if($Gender['Stu_Speed_YardDashIncheID']==$Profile['Juco_Ins_YardDashIncheID']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Speed_MileID'); ?>
                                    <select name="Juco_Ins_Mile" id="Juco_Ins_Mile">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Speed_MileID']; ?>" <?php if($Gender['Stu_Speed_MileID']==$Profile['Juco_Ins_Mile']){ ?> selected="selected" <?php } ?>>
                                ...
                                'Stu_Speed_MileIncheID'); ?>
                                    <select name="Juco_Ins_MileIncheRunID" id="Juco_Ins_MileIncheRunID">
                                        <option value="0">
                                         ...
                                         <?php foreach($Gender_details as $Gender){ ?>
                                             <option value="<?php echo $Gender['Stu_Speed_MileIncheID']; ?>" <?php if($Gender['Stu_Speed_MileIncheID']==$Profile['Juco_Ins_MileIncheRunID']){ ?> selected="selected" <?php } ?>>
		...
		if($('#Juco_State').val()=='0')
		 {
			...
			$('#Juco_State').css('border','1px solid red');
			sucess = false;
		 } 
		 else {
			$('#Juco_State').css('border','1px solid #a4a4a4');
			}
			
		if($('#Juco_City').val()=='')
		 {
			
			$('#Juco_City').css('border','1px solid red');
			sucess = false;
		 } 
		 else {
			$('#Juco_City').css('border','1px solid #a4a4a4');
			}			
...
$(document).ready(function(e) {
    var IntendID='<?php echo $Profile['Juco_Act_IntendedID']; ?>'; 
	var MajorID='<?php echo $Profile['Juco_Act_MajorID']; ?>'; 
	if(IntendID!='0')
	{
		$("#Juco_Act_MajorID").html("<option>Loading...</option>");
		 $.ajax({
