    ...
    <section class="content">
        <div class="inner-content">
        	<div class="wrapper">
                ...
                <?php }?>
                <div class="reg-text">
                    <p>CONGRATULATIONS, your MyRecruitBoard profile is complete! Now you can navigate the site freely.  Don't forget to visit our forums and chat with other MyRecruitBoard members. Also, remember to use the evaluation feature to give your honest feedback about any student athletes you have worked with. Come back daily to share your new updates and connect with more MyRecruitBoard members.</p>
                    
				</div>
                <div class="rb-logo">
                	<a href="index.html" title="Recruitment Board">
