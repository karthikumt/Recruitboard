<div class="dashboard-coach-ads coach-height" id="somediv">
    <div class="wrapper">
          <div class="my_Account">
              ...
              <div class="postedAds">
                    ...
                    <div class="athlete-view hp-add" id="ad-holder">
  ...
  <?php echo $PostAds[$i]['Po_Username']; ?></a></li>
                       ...
                       <?php } } ?> 
                        ...
                        <div class="btn-ads" style=" background-position:center; background-repeat:no-repeat; height:32px; width: 200px;margin: auto; text-align:center"><a href="javascript:void(0);" id="load-more" data-page="0">Load more</a></div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
	$('#load-more').click( function (){
		...
		var url = '<?php echo site_url('myrecruitads1/adsbypage') ?>';
