        ...
        <div class="inner-content" >
            ...
            <div class="wrapper">
             ...
             <?php if($this->session->flashdata('ErrorMsg')){?> 
                ...
                <?php }?>
                <form name="coll_step1" method="post" action="<?php echo base_url('colleage_admission/insert_step1'); ?>" onsubmit="return check_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                <div class="reg-frm">
                    ...
                    <div class="frm clearfix">
                        ...
                        <div class="inner-frm fr">
                        	<input type="text" name="University" id="University" placeholder="University/College">
                        </div>
                    </div>
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                        <?php $Country_detail = get_table_details('coll_admi_country','Coll_admi_CountryID'); ?>
                        	<select name="Country" id="Country">
                            	<option value="0">Select Country</option>
                                 <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Coll_admi_CountryID']; ?>">
                                <?php echo $Country_detail[$i]['Coll_admi_CountryName']; ?></option>
                                <?php } ?>
                            </select>
                         </div>
                        <div class="inner-frm fr">
                    ...
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                        	<input type="text" name="SchoolWeb" placeholder="School Website (link)">
                         </div>
                    </div>
                    <div class="frm clearfix">
                    	<div class="fileupload" id="fileupload">
                    		...
                    		<input type="file" class="filefild" name="ProfilePic" id="ProfilePic">
                            </div>
                             <script>
                   ...
                   <div class="frm clearfix">
                     <div class="inner-frm fl">
                      ...
                      <span style="display:none; float:left;" id="unnsuccessemail" class="error_data">Invalid Email Address.</span>
                       <span style="display:none; float:left;" id="Emailvalid" class="error_data">Email Already Registered.</span>
                        ...
                        <div class="inner-frm fr">
                         <input type="text" placeholder="Verify your email address" id="VerifyEmail" >
                    ...
                    <div class="frm clearfix">
                     <div class="inner-frm fl">
                        ...
                        <div class="inner-frm fr">
                         <input type="password" placeholder="Verify Password " id="VerifyPassword" >
                    ...
                    <div class="frm captch-frm clearfix">
                    	...
                    	<div class="inner-frm fl">
                        	<input type="submit" name="save"  value="Continue" id="save">
                            <img id="loadimg" src="<?php echo base_url('images/ajax-loader.gif'); ?>" style="display:none"/>
                         </div>
  	 ...
  	 var confPass = $('#VerifyPassword').val();
		...
		if(pass != confPass) {
		 ...
		 if($('#University').val()=='')
		 {
			...
			$('#University').css('border','1px solid #a4a4a4');
			} 
