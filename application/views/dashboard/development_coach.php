 ...
 $('.popup-with-zoom-anim').magnificPopup({
   ...
   <div class="dashboard-banner">
        <div class="HomeLoader" id="CoverLoaderID"></div>
   	  <div id="cover_image">
	   <?php if(!empty($UserInfo['Devel_CoverImage'])){
       if(file_exists("./register_images/developement_coach/cover_small/".$UserInfo['Devel_CoverImage']."")){?>
         <img src="<?php echo base_url(); ?>register_images/developement_coach/cover_small/<?php echo $UserInfo['Devel_CoverImage']; ?>" alt="">
        <?php }else{  ?>
          ...
          <div class="edit">
                <a onclick="$('#Devel_CoverImage').trigger('click');" href="javascript:void(0);"></a>
            </div>
    </div>
            	...
            	<div class="first-section">
                	...
                	<div class="img fl">
                       ...
                       <div id="ProfileImage">
                        ...
                        <div class="edit">
                        	<a href="javascript:void(0);" onclick="$('#Devel_ProfileImage').trigger('click');"></a>
                        </div>
                    </div>
         ...
         <img src="<?php echo $vimeo[0]['thumbnail_large'];?>" />
                                   ...
                                   <?php } else {?> 
                                     <video width="480" height="360" controls>
                                          <source src="<?php echo $UserInfo['Devel_VideoURL']; ?>" type="video/mp4">
                            ...
                            <div class="info clearfix">
                                ...
                                <div class="prof-info fr">
                                    ...
                                    <?php $getdata=get_row_data('developement_coach_country','Dev_CountryID',$UserInfo['Devel_CountryID']); ?>
                                    	...
                                    	<li class="location"><?php echo $getdata['Dev_CountryName']; ?></li>   
                                        <li class="view-count">274 Views</li>
                                        <li class="phone"><a href="tel:<?php echo $UserInfo['Devel_Phone']; ?>"><?php echo $UserInfo['Devel_Phone']; ?></a></li>            
                                         <li class="web"><a target="_blank" href="<?php echo $UserInfo['Devel_Website']; ?>"> <?php echo $UserInfo['Devel_Website']; ?></a></li>
                                ...
                                <div class="team-desc clearfix">
                                     <div class="desc-fulid clearfix">
                                            <div class="team-ldesc fl">
                                                ...
                                                <p><?php echo $UserInfo['Devel_Attend']; ?></a></p>
                                            </div>
                                            <div class="team-rdesc fl">
                                                <h5>Qualifications</h5>
                                                <p>L<?php echo $UserInfo['Devel_Qualification']; ?></a></p>
                                            </div>
                                     </div>
                                </div>
                                <div class="t-mission">
                                	<h5>Mission</h5>
                                    <p><?php echo $UserInfo['Devel_Service']; ?></a></p>
                                </div>
...
<form method="post" action="<?php echo base_url(); ?>dashboard/devel_profile_image" id="MyUploadForm" enctype="multipart/form-data">
	<input type="hidden" name="action" value="upload_profile_pic" />
    <input type="file" name="Devel_ProfileImage" id="Devel_ProfileImage" />
</form>

<form method="post" action="<?php echo base_url(); ?>dashboard/devel_cover_image" id="MyCoverImage" enctype="multipart/form-data">

    <input type="file" name="Devel_CoverImage" id="Devel_CoverImage" />
</form>
...
<script type="text/javascript">
 $(function(){
            ...
            $('#MyUploadForm').on('change',function(e){
                e.preventDefault();	
			   	var file = $('#Devel_ProfileImage')[0].files[0];
 ...
 $(function(){
			...
			$('#MyCoverImage').on('change',function(e){
             	e.preventDefault();	
			   	var file = $('#Devel_CoverImage')[0].files[0];
				var fileName = file.name;
				var fileExt = fileName.split('.').pop();
				var fileExt = fileExt.toLowerCase();
				if(fileExt=='jpg' || fileExt=='jpeg' || fileExt=='png'){
...
<script>    
 ...
 $('#myvideo').magnificPopup({
   items: {
       src: '<?php echo $UserInfo['Devel_VideoURL']; ?>',
       type: 'iframe'
    },
});
</script>
