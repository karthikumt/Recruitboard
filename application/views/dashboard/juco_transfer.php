    ...
    <div class="dashboard-content">
        ...
        <?php } ?>
                    ...
                    <div class="profile-text clearfix">
                        ...
                        <?php 
$profile_link_url = base_url()."juco_transfer_v?userid=".$this->session->userdata('MyRecuritID');
//echo $profile_link_url;
?>                        <div class="msg-details fr socialicons">
                            <div class="dash-title sharebtn" href="#share-buttons" id="fancyBoxshare">
                                    <h3>Share</h3>
                                    
                                </div>

                            <div id="share-buttons" style="display:none">
                                <a href="#sharelink" id="fancyBoxLink">
                                   <img src="<?php echo base_url(); ?>images/social/link-32.png" alt="">
                                ...
                                <!-- Twitter -->
                                <?php $turl = "https://twitter.com/share?url=".$profile_link_url;  ?>
                                <a calss="fancybox-close" href="#" onclick="tshare('<?php echo $turl ?>')" >
                                    <img src="<?php echo base_url(); ?>images/social/twitter_letter-32.png" alt="Twitter" />
                                </a>

                            </div>
                            <div class="msg-btn " style="display:none;">
...
<div class="fb-share-button" data-href="<?php echo $profile_link_url; ?>" data-layout="button"></div>

<br>
<br>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $profile_link_url; ?>" data-text="testing twitter" data-related="xcf" data-count="none">Tweet</a>
                                  ...
                                  <?php } ?>  
                                    ...
                                    <div class="frm clearfix">
                                     <div class="frm" id="Video_Up" style="display:none;">
                                        <input type="text" id="Juco_VideoURL" name="Juco_VideoURL" placeholder="https://www.myrecruitboard.com"/>
                                               ...
                                               <script>
                                                function getbiomentric()
                                                    {   
                                                        $.magnificPopup.open({
                                                            items: {
                                                                src: '<?php echo base_url(); ?>dashboard_juco/getBiometric/'
                                                              },
                                                              type: 'ajax',
                                               ...
                                               <script>
                                                    function getAcedmic()
                                                        {   
                                                            $.magnificPopup.open({
                                                                items: {
                                                                    src: '<?php echo base_url(); ?>dashboard_juco/getAcedmic/'
                                                                  },
                                                                  type: 'ajax',
                                                                  closeOnContentClick:false,
                                                                  closeOnBgClick: false
                                              ...
                                              <script>
                                                function getSports()
                                                    {   
                                                        $.magnificPopup.open({
                                                            items: {
                                                                src: '<?php echo base_url(); ?>dashboard_juco/getSports/'
                                                              },
                                                              type: 'ajax',
                                                              closeOnContentClick:false,
                                                              closeOnBgClick: false
...
<script type="text/javascript">
    $("#fancyBoxshare").fancybox({
     ...
     function fshare(url){
        //alert("fshare");
        $.fancybox.close();
        window.open(url, 'mywin', 'left=300,top=50,width=500,height=500,toolbar=1,resizable=0'); return false;
    }
    function tshare(url){
        //alert("tshare");
        $.fancybox.close();
