                                ...
                                <div class="team-desc clearfix">
                                     <div class="desc-fulid clearfix">
                                            <div class="team-ldesc fl">
                                                <h5>Division</h5>
                                                 <?php
                                                  ...
                                                  $getdata=get_row_data('coll_cotch_division','Coll_DivisionID',$UserInfo['Coach_DivisionID']); ?>
                                            ...
                                            <div class="team-rdesc fl">
                                                ...
                                                <p><?php error_reporting(0); echo $getdata['Coll_ProgramName']; ?></p>
                                            </div>
                                     </div>
                                     <div class="desc-fulid clearfix">
                                            <div class="team-ldesc fl">
                                            ...
                                            <div class="team-rdesc fl">
                                                ...
                                                <p><?php error_reporting(0); echo @$getdata['Coll_PlayoffName']; ?></p>
                                            </div>
                                     </div>
                                     <div class="desc-fulid clearfix">
                                            <div class="team-ldesc fl">
