...
<!-- end facebok share-->
                ...
                <div class="dashboard-box clearfix">
                    ...
                    <!--My Videos -->
                        ...
                        echo  $url = $UserInfo['Stu_VideoURL'];
                        $url = str_replace('Check out my highlight:   ','',$url);
                                   ...
                                   <?php } else if($GetUrl=='hudl') {  ?>
                                    <div id="athe"></div>
                                   <a class="play-icon" id="myvideo" href="<?php echo str_replace('Check out my highlight:   ','',$url); ?>">
