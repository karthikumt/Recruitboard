            ...
            <div class="panel-body panel-body-nopadding">
              ...
              <div class="basic-wizard" id="basicWizard">
                ...
                <ul class="nav nav-pills nav-justified">
                   <li class="active"><a href="<?php echo base_url(); ?>admin/developement_coach"><span>Step 1</span></a></li>
                 
                  <li class=""><a href="<?php echo base_url(); ?>admin/developement_coach_four"><span>Step 4</span></a></li>
                  ...
                  <div id="accordion" class="panel-group">
                      ...
                      <table class="table mb30">
                        ...
                        <tbody id="Country_List">
                            <?php $Gender_details=get_table_details('developement_coach_country','Dev_CountryID'); ?>
                                ...
                                jQuery.fancybox.open([
                                    {
                                        ...
                                        closeEffect: 'none',
                                        type: 'ajax',
                                        href: '<?php echo base_url(); ?>admin/developement_coach/add_country/',
                                    }
                                ]);
                            });
                        function remove_country(Dev_CountryID)
                        {
                            if(confirm("Are You Sure?"))
                            {
                                 $.ajax({
                                    url:'<?php echo base_url(); ?>admin/developement_coach/delete_country/',
                                    type:'POST',
                                    data:{Dev_CountryID:Dev_CountryID},
                                    success:function(result){
                                      $('#Country_'+Dev_CountryID).remove();
                                    }
