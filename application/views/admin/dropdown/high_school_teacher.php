            ...
            <div class="panel-body panel-body-nopadding">
              ...
              <div class="basic-wizard" id="basicWizard">
                ...
                <ul class="nav nav-pills nav-justified">
                   <li class="active"><a href="<?php echo base_url(); ?>admin/high_school_teacher"><span>Step 1</span></a></li>
                  ...
                  <div id="accordion" class="panel-group">
                      ...
                      <table class="table mb30">
                        ...
                        <tbody id="Country_List">
                            <?php $Gender_details=get_table_details('high_teacher_country','High_teacher_CountryID'); ?>
                                ...
                                jQuery.fancybox.open([
                                    {
                                        ...
                                        closeEffect: 'none',
                                        type: 'ajax',
                                        href: '<?php echo base_url(); ?>admin/high_school_teacher/add_country/',
                                    }
                                ]);
                            });
                        function remove_country(High_teacher_CountryID)
                        {
                            if(confirm("Are You Sure?"))
                            {
                                 $.ajax({
                                    url:'<?php echo base_url(); ?>admin/high_school_teacher/delete_country/',
                                    type:'POST',
                                    data:{High_teacher_CountryID:High_teacher_CountryID},
                                    success:function(result){
                                      $('#Country_'+High_teacher_CountryID).remove();
                                    }
