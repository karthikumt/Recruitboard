          ...
          <table class="table" id="table2">
              ...
              <tbody>
                 ...
                 <?php for($i=0;$i<count($user_list);$i++){ 
                   $profile_link_url = base_url()."juco_transfer_v?userid=".$user_list[$i]['UserID'];?> 
                     <tr class="gradeC">
                        ...
                        <td><?php echo $step; ?></td>
                         <td><?php $data=get_juco_detail($user_list[$i]['UserID']); 
                if($data['Juco_SportID']!="")
                {
                  $sports=get_row_data('stu_athlete_sport','SportID',$data['Juco_SportID']);
            ...
            ?>
                        ...
                        <td>
                        <?php
                            if($data['Juco_ClassID']!=""){
                  $sports=get_row_data('stu_athlete_class','ClassID',$data['Juco_ClassID']);
