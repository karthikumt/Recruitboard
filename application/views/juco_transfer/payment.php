        ...
        <div class="inner-content">
        	...
        	<div class="register stud-athlete">
                ...
                <?php }?>
                   ...
                   <form name="stu_step1" method="post" action="<?php echo base_url('juco_transfer/insert_step8'); ?>" onsubmit="return check_stu_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                <div class="reg-frm">
