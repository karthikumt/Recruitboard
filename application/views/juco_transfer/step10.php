 ...
 <div class="HomeLoader" id="ProcessLoaderID"></div>
        <div class="inner-content">
        	<div class="wrapper">
                ...
                <?php }?>
                     <form name="stu_step3" method="post" action="<?php echo base_url('juco_transfer/insert_step10'); ?>" onsubmit="return check_stu_validation();" >
                    <div class="reg-frm step10">
                	    <div class="qualification">
                            <h6>What areas of your game do you need developed?</h6>
                            <div class="frm clearfix">
                                <div class="qul-textbox fl"> 
                                    <select name="Juco_DeveloperID" id="Juco_DevlopID">
                                    	<option value="0">
                        ...
                        <div class="qualification">
                            ...
                            <div class="frm clearfix">
                                <div class="qul-textbox fl"> 
                                     <select name="Juco_NeedID" id="Juco_NeedID">
                                    	<option value="0">
                                        	Select Acedmic Area
                                        </option>
     ...
     function check_stu_validation()
	  {
		 var sucess = true;
			 ...
			 if($('#Juco_DevlopID').val()=='0')
			 {
				$('#Juco_DevlopID').css('border','1px solid red');
				sucess = false;
			 } 
			 else {
				$('#Juco_DevlopID').css('border','1px solid #a4a4a4');
				}
