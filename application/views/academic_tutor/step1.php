   ...
   <div class="HomeLoader" id="ProcessLoaderID"></div>
        <div class="inner-content">
        	<div class="wrapper">
                ...
                <?php }?>
                <form name="ac_step1" method="post" action="<?php echo base_url('academic_tutor/insert_step1'); ?>" onsubmit="return check_ac_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                <div class="reg-frm">
                    ...
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                        	<input type="text" placeholder="Business Name or Specialty" name="BusinessName" id="BusinessName">
                         </div>
                        <div class="inner-frm fr">
                    	...
                    	<div class="inner-frm fl">
                        	<select name="Country" id="Country">
                            	<option value="0">Country</option>
                                     ...
                                     <?php $Country_detail = get_table_details('academic_country','Academic_CountryID'); ?>
                                      <?php for($i=0;$i<count($Country_detail);$i++) { ?>
                                <option value="<?php echo $Country_detail[$i]['Academic_CountryID']; ?>">
                                <?php echo $Country_detail[$i]['Academic_CountryName']; ?></option>
                                <?php } ?>
                            </select>
                         </div>
                        <div class="inner-frm fr">
                        	<input type="text" placeholder="Zip/Postal Code" name="ZipCode" id="ZipCode">
                        </div>
                    </div>
                    <div class="frm clearfix">
                    	<div class="inner-frm fl">
                    ...
                    <div class="frm captch-frm clearfix">
                        <div class="inner-frm fr">
                                <div class="capcha">
                                    ...
                                    <a href="javascript:void(0);" class ="refresh" id="refresh"><img id="" src ="<?php echo base_url(); ?>images/refresh.png"></a>
                                    <img id="capload" src ="<?php echo base_url(); ?>images/cap_loader.gif" style="display:none;">
                                    </div>
                                     <input type="text" placeholder="" name="Captcha" id="Captcha" value="">
                                </div>
                            </div>
                    	<div class="inner-frm fl">
  	 ...
  	 var confPass = $('#VerifyPassword').val();
		...
		if(pass != confPass) {
		 ...
		 if($('#BusinessName').val()=='')
		 {
			...
			$('#BusinessName').css('border','1px solid #a4a4a4');
			} 
