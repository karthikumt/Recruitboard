 ...
 <div class="HomeLoader" id="ProcessLoaderID"></div>
        <div class="inner-content">
        	<div class="wrapper">
                ...
                <?php }?>
                <form id="basicForm" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" action="<?php echo base_url(); ?>student_athlete/insert_step4" onsubmit="return getStudent_data();">
                    <div class="reg-frm">
                    	<div class="frm clearfix">
                    		<div class="cols-5">
                            	<input type="text" placeholder="Player Name" name="Stu_Act_Player" id="Stu_Act_Player">               
                            </div>
                            <div class="cols-5">
                            	<input type="text" placeholder="High School Name" name="Stu_Act_HighSchool" id="Stu_Act_HighSchool">
                            </div>
                            <div class="cols-5">
                            	<input type="text" placeholder="City" name="Stu_Act_City" id="Stu_Act_City">
                            </div>
                            <div class="cols-5">
                            	<input type="text" placeholder="State" name="Stu_Act_State" id="Stu_Act_State">
                            </div>
                            <div class="cols-5">
                            	<input type="text" placeholder="Class of 20" name="Stu_Act_Class">
                            </div>
                        </div>
                    ...
                    <div class="student-card clearfix">
                            ...
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                        ...
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Arts" value="1">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Religion
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Religion" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Clubs/organizations
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Clubs" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Community Service
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Community" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Student Goverment
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Goverment" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Media / Newspaper
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Media" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	MIlitary R.O.T.C
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Military" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Music
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Music" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <input type="text" placeholder="Other" name="Stu_Act_Other" >
                                </div>
                            </div>
                        </div>
						<div class="cols-big">
                        ...
                        <div class="cols-small">
                        	<div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <input type="text" placeholder="Name" name="Stu_Act_GuName" id="Stu_Act_GuName">
                                </div>
                                <div class="frm">
                                    <input type="text" placeholder="Email" name="Stu_Act_GuEmail">
                                </div>
                            </div>
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	Honors Courses
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Honors" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                        ...
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Post" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	AP Courses
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_ApCourses" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <input type="text" placeholder="Languages" name="Stu_Act_Languages">
                                </div>
                            </div>
                            <div class="reg-frm pitching-stats">
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	NCAA
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Ncaa" value="1">
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
                                ...
                                <div class="frm">
                                    <div class="added-value">
                                    	NAIA
                                        <div class="btn-checkbox">
                                        	<input type="checkbox" name="Stu_Act_Naia" value="1"> 
                                        	<div class="no-check">No</div>
                                            <div class="yes-check">Yes</div>
                                        </div>
                                    </div>
