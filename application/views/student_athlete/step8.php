        	...
        	<div class="wrapper">
                ...
                <?php }?>
                    ...
                    <div class="features-box clearfix" style="    margin-left: 0;">
                            <form name="stu_step3" id="stu_step4" method="post" action="<?php echo base_url('student_athlete/free_payment'); ?>"  class="form-horizontal form-bordered" enctype="multipart/form-data">   
                          <div class="cols">
                          		<div class="ft-title">
                                	Free Membership
                        ...
                        <!--<form name="stu_step3" id="stu_step3" method="post" action="<?php echo base_url('student_athlete/payment'); ?>"  class="form-horizontal form-bordered" enctype="multipart/form-data">   
                          <div class="cols-2">
                          		<div class="ft-title">
                                	Premium Membership
                                	<div class="ft-innertitle">
