...
highlight your strengths!</h3>
                ...
                <?php }?>
                <form name="stu_step3" method="post" action="<?php echo base_url('student_athlete/insert_step7'); ?>"  class="form-horizontal form-bordered" enctype="multipart/form-data" onsubmit="return check_stu_validation()">
                <div class="reg-frm">
                    	...
                    	<div class="frm">
                        	<div class="video-upload">
                                ...
                                <div class="right-silde">
                                 ...
                                 <input type="text" name="Stu_VideoUrl" id="Stu_VideoUrl" />
                    ...
                    <div class="frm clearfix">
                    	<input type="text" placeholder="What player do you model your game after?" name="Stu_Player" id="Stu_Player" >
