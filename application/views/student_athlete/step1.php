...
away so you are one step closer to getting recruited!</p>
                ...
                <?php }?>
                   <form name="stu_step1" method="post" action="<?php echo base_url('student_athlete/insert_step1'); ?>" onsubmit="return check_stu_validation();" class="form-horizontal form-bordered" enctype="multipart/form-data">
                <div class="reg-frm">
                    ...
                    <div class="frm clearfix">
                    	<div class="fileupload" id="fileupload">
                    		...
                    		<input type="file" class="filefild" name="Stu_ProfileImage" id="Stu_ProfileImage">
