...
additional exposure that you may need if you are not currently being recruited.</h3>
                ...
                <?php }?>
               <form name="stu_step3" method="post" action="<?php echo base_url('student_athlete/insert_step9'); ?>" onsubmit="return check_stu_validation();" >
                    ...
                    <div class="frm">
                    	<textarea placeholder="What makes you unique?"  name="Stu_Content" id="Stu_Content"></textarea>
                    </div>
     ...
     function check_stu_validation()
	  {
		 var sucess = true;
			 ...
			 if($('#Stu_Content').val()=='')
			 {
				$('#Stu_Content').css('border','1px solid red');
				sucess = false;
			 } 
			 else {
				$('#Stu_Content').css('border','1px solid #a4a4a4');
				}
