...
class Juco_transfer extends CI_Controller {
 ...
 public function __construct()
	...
	public function insert_step2()
	{
		...
		if($Juco_info['Juco_GenderID']!='0' && $Juco_info['Juco_SportID']!='0' && $Juco_info['Juco_CountryID']!='0' && $Juco_info['Juco_SchoolName']!=""  && $User['FirstName']!="" && $User['LastName']!=""  && $Juco_info['Juco_ZipCode']!="" && $Juco_info['Juco_HeightID']!='0'  && $Juco_info['Juco_ClassID']!='0'  && $Juco_info['Juco_InchesID']!='0'  && $Juco_info['Juco_WeightID']!='0' && $Juco_info['Juco_State']!='0'  && $Juco_info['Juco_City']!='' ){
