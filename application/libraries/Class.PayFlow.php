...
class PayFlow {
  ...
  */
   ...
   * @uses      Sets the type of transaction.
   */
  public function setOptionalTransactionType($transactionType = 'S') {
    $type = array(
      'OPTIONALTRX'=>strtoupper($transactionType),
    );

    $this->NVP = array_merge($this->NVP, $type);
  }

 public function setORIGPROFILEID($PROFILEID) {
    $type = array(
      'ORIGPROFILEID'=>strtoupper($PROFILEID),
    );
    $this->NVP = array_merge($this->NVP, $type);
  }	
  ...
  /**
   * Sets extra amount, required for recurring transaction
   */
  public function setExtraAmount($amount = 0, $wholeAmt) {
    $amt = array(
  ...
  public function setCustomerFirstName($firstName = '') {
    $first = array(
      'BILLTOFIRSTNAME'=>$this->truncateChars($firstName, 30),
    );
  ...
  public function setCustomerLastName($lastName = '') {
    $last = array(
      'BILLTOLASTNAME'=>$this->truncateChars($lastName, 30),
    );  
...
/*public function setCustomerFirstName($customerFirstName = '') {
    $firstname = array(
      'BILLTOFIRSTNAME'=>$this->truncateChars($customerFirstName, 40),
    );

    $this->NVP = array_merge($this->NVP, $firstname);
  }

  public function setCustomerLastName($customerLastName = '') {
    $firstname = array(
      'BILLTOLASTNAME'=>$this->truncateChars($customerLastName, 40),
    );
...
/*first name and last name fields*/
  ...
  public function setCustomerCountry($customerCountry = '') {
    $country = array(
      'BILLTOCOUNTRY'=>$this->truncateChars($customerCountry, 1),
    );
